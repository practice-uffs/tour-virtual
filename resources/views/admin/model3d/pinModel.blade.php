...
<script id='source' type="module">
    ...
    sceneModel.on("loaded", function () {
        ...
        const sceneModel2 = xktLoader.load({
            id: "myModel",
            src: "/3d_model/files/xkt/"+'{{$model3d->file}}',
            excludeTypes: ["IfcSpace", "IfcBuilding", "IfcSite"],
            edges,
            saoEnabled,
            useDataTextures: {
...
//----------------------------------------------------------------------------------------------------------------------
    ...
    const annotations = new AnnotationsPlugin(viewer, {
        ...
        "<div class='annotation-title'></div><div class='annotation-desc'><form method='POST' action=''><input type='text'/><button>Salvar</button</form></div></div>",
    ...
    viewer.scene.input.on("mouseclicked", (coords) => {
        ...
        if (pickResult) {
            console.log(pickResult._worldPos)

            const annotation = annotations.createAnnotation({
                id: "myAnnotation" + annotationCounter,
                ...
                values: {               // HTML template values
                    glyph: "A" + annotationCounter,
                    title: "My annotation " + annotationCounter,
                    description: "My description " + annotationCounter
                },
            });
